...
scope assessment. Drawing on my experience and working with
other Support Engineers to validate the behavior, we established that 
the vulnerability actually affected all authentication mechanisms, 
...
actual authentication paths to confirm exposure, and cross-checked it against
real LDAP-configured environments rather than relying on the advisory's stated scope.
