...
a GitLab instance's Identity Provider (IdP) was compromised. For compliance (and likely legal) concerns,
...
Prior to this [step](https://docs.gitlab.com/user/profile/active_sessions/#revoke-all-sessions-for-all-users)
being published there was no easy to revoke all active sessions for a group. This was uncharted territory
and needed validation for a production environment.
...
team to formulate a path forward until this [feature request](https://gitlab.com/gitlab-org/gitlab/-/work_items/385091) is implemented.
